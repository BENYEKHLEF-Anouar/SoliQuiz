        ...
        <div class="mt-7 bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
            <div class="p-4 sm:p-7">
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-sm text-slate-500 font-medium">Rejoignez la plateforme d'évaluation interactive.</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="grid gap-y-4">
                        ...
                        <!-- Input Password -->
                        <div>
                            <label for="password" class="block text-sm mb-2 text-slate-800 font-medium">Mot de passe</label>
                        ...
                        <!-- Confirm Password -->
                        <div>
                            <label for="password-confirm" class="block text-sm mb-2 text-slate-800 font-medium">Confirmer le mot de passe</label>
            ...
            <div class="bg-white border-t border-slate-100 p-4 text-center">
                <p class="text-sm text-slate-600">
                    Déjà un compte ? <a href="{{ route('login') }}" class="text-primary-500 font-bold hover:underline">Se connecter ici.</a>
                </p>
            </div>
        </div>
    </main>
