        ...
        <div class="mt-7 bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
            <div class="p-4 sm:p-7">
                <div class="text-center mb-8">
                    <div class="flex justify-center mb-6">
                        <a href="{{ url('/') }}" class="flex items-center gap-2 group outline-none">
                            <div class="size-12 bg-primary-500 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/20 transition-transform group-hover:scale-110">
                                <svg class="text-white size-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                                    <polyline points="14 2 14 8 20 8" />
                                    <path d="m9 15 2 2 4-4" />
                                </svg>
                            </div>
                            <span class="text-3xl font-heading font-bold text-slate-900 tracking-tight">Soli<span class="text-primary-500">Quiz</span></span>
                        </a>
                    </div>
                    <h1 class="block text-2xl font-bold font-heading text-slate-900 tracking-tight">Espace d'évaluation</h1>
                    <p class="mt-2 text-sm text-slate-500 font-medium">Connectez-vous avec vos identifiants Solicode.</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="grid gap-y-4">
                        <!-- Input Email -->
                        <div>
                            <label for="email" class="block text-sm mb-2 text-slate-800 font-medium">Adresse Email</label>
                            <div class="relative">
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                <label for="password" class="block text-sm text-slate-800 font-medium">Mot de passe</label>
                        ...
                        <div class="flex items-center mt-2">
                            ...
                            <div class="ms-3">
                                <label for="remember" class="text-sm font-medium text-slate-700 cursor-pointer">Se souvenir de moi</label>
                            </div>
                        </div>
            ...
            <div class="bg-slate-50 border-t border-slate-200 p-4 text-center">
                <p class="text-xs text-slate-500">
                    Problème d'accès ? <a href="#" class="text-primary-500 font-medium hover:underline">Contactez l'administration.</a>
                </p>
            </div>
            ...
            @if (Route::has('register'))
                <div class="bg-white border-t border-slate-100 p-4 text-center">
                    <p class="text-sm text-slate-600">
                        Pas encore de compte ? <a href="{{ route('register') }}" class="text-primary-500 font-bold hover:underline">Inscrivez-vous ici.</a>
                    </p>
                </div>
            @endif
        </div>
