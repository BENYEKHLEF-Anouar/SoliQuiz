            ...
            <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
                <div class="relative z-10">
                    ...
                    <div class="flex flex-col sm:flex-row gap-5">
                        <a href="{{ route('login') }}"
                            class="py-5 px-12 bg-primary-500 text-white font-bold rounded-2xl hover:bg-primary-600 transition-all shadow-xl shadow-primary-500/30 text-center uppercase tracking-widest group">
                        ...
                        <a href="#features"
                            class="py-5 px-12 bg-white text-slate-700 border border-slate-200 font-bold rounded-2xl hover:bg-slate-50 transition-all text-center uppercase tracking-widest shadow-sm">
                            Découvrir
                        </a>
                    </div>
                </div>
