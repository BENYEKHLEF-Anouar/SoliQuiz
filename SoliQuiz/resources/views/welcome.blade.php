            ...
            <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
                <div class="relative z-10">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 items-start">
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center justify-center py-3 px-6 bg-primary-500 text-white font-semibold rounded-xl hover:bg-primary-600 transition-all shadow-lg shadow-primary-500/15 text-center text-xs uppercase tracking-wider group">
                            Commencer maintenant
                            <svg class="inline-block ml-1.5 size-3.5 transition-transform group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                            </svg>
                        </a>
                        <a href="#features"
                            class="inline-flex items-center justify-center py-3 px-6 bg-white text-slate-600 border border-slate-200/80 font-semibold rounded-xl hover:bg-slate-50 hover:border-slate-300 transition-all text-center text-xs uppercase tracking-wider shadow-sm">
                            Découvrir
                        </a>
                    </div>
                </div>
