...
<div class="reveal active pb-48" x-data="qcmLibrary({
    ...
    <div class="flex flex-col sm:flex-row gap-3 mb-4">
        ...
        <!-- UA Filter -->
        <div x-data="{ open: false, searchUa: '' }" class="relative w-full sm:w-56" @click.away="open = false">
            ...
            <div x-show="open" style="display: none;" class="absolute top-full left-0 w-full mt-2 bg-white border border-slate-100 rounded-xl shadow-xl z-50 overflow-hidden">
                ...
                <div class="p-2 max-h-60 overflow-y-auto">
                    ...
                    @foreach($unites as $unite)
                        <button type="button" 
                                x-show="!searchUa || '{{ strtolower(addslashes($unite->nom)) }}'.includes(searchUa.toLowerCase())"
