import { secureFetch } from '../common/helpers';

export default function aiExplain(questionId, tentativeId) {
    return {
        questionId,
        tentativeId,
        loading: false,
        ...
        async explain() {
            ...
            try {
                const res = await secureFetch('/etudiant/ai/explain-question', {
                    method: 'POST',
                    body: {
