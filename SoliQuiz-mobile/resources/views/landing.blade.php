...
@section('content')
<div class="h-full flex flex-col relative overflow-hidden font-sans antialiased text-slate-800">

    <div class="h-[44px] w-full shrink-0"></div>

    <header class="sticky top-0 w-full bg-white/80 backdrop-blur-md z-50 border-b border-slate-100 px-6 py-4 flex justify-between items-center transition-all">
        <div class="flex items-center gap-2 group">
            ...
            <span class="text-xl font-heading font-black tracking-tight text-slate-900 leading-none">Soli<span class="text-primary-500">Quiz</span></span>
        </div>
    ...
    <main class="flex-1 overflow-y-auto scroll-smooth">
        <section class="px-6 py-12 relative overflow-hidden">
            ...
            <span class="inline-flex items-center bg-primary-50 text-primary-600 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-4">
            ...
            <div class="flex flex-col gap-3">
                <a href="{{ route('login') }}" class="w-full py-4 bg-primary-500 text-white font-black rounded-2xl text-center uppercase tracking-widest text-xs shadow-xl shadow-primary-500/30 active:scale-[0.98] transition-all">
                    Se Connecter maintenant
                </a>
                <a href="#features" class="w-full py-4 bg-white border border-slate-200 text-slate-700 font-bold rounded-2xl text-center uppercase tracking-widest text-xs active:scale-[0.98] transition-all">
                    Découvrir plus
                </a>
            </div>

            <div class="mt-12 relative">
                <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=600" class="rounded-3xl shadow-2xl border-4 border-white transform rotate-2" alt="Apprenants">
                <div class="absolute -bottom-4 -left-4 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-3 animate-bounce-slow">
        ...
        <section id="features" class="px-6 py-12 bg-slate-50">
            <div class="space-y-6">
                <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-5">
                    <div class="size-12 bg-primary-50 text-primary-500 rounded-xl flex items-center justify-center shrink-0">
        ...
        <section class="px-6 py-12 text-center">
            ...
            <a href="{{ route('login') }}" class="inline-flex py-3 px-8 bg-slate-900 text-white font-black rounded-xl text-xs uppercase tracking-widest active:scale-95 transition-all">
                Accéder à mon espace
            </a>

            <footer class="mt-20 pt-8 border-t border-slate-100 pb-12">
                <div class="flex items-center justify-center gap-2 opacity-30 mb-4">
                    <div class="size-6 bg-slate-900 rounded-md"></div>
                    <span class="font-heading font-black text-sm uppercase">SoliQuiz</span>
                </div>
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-loose">
                    © 2026 — Solicode & OFPPT<br>Design & Experience Mobile First
                </p>
            </footer>
        </section>
    </main>
