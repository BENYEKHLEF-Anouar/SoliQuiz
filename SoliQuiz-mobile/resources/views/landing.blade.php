...
<header
    ...
    <div class="flex items-center gap-2 group">
        <div
            class="size-8 bg-primary-500 rounded-lg flex items-center justify-center shadow-lg shadow-primary-500/10">
...
<main class="flex-1 overflow-y-auto scroll-smooth">
    ...
    <section id="features" class="px-6 py-12 bg-slate-50">
        <div class="space-y-6">
            ...
            <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-5">
                <div
                    class="size-12 bg-amber-50 text-amber-600 rounded-xl flex items-center justify-center shrink-0">
                    <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                        <path
