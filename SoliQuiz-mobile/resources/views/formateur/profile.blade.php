...
@section('content')
<div x-data="formateurProfile" x-init="init()" class="h-full flex flex-col relative overflow-hidden bg-slate-50">
    <!-- Header -->
    <header class="bg-white/80 backdrop-blur-md px-5 pt-safe-top pb-4 border-b border-slate-100 shadow-[0_1px_3px_rgba(0,0,0,0.02)] shrink-0 sticky top-0 z-40">
        ...
        <div class="flex justify-between items-center mt-2">
            <div class="flex items-center gap-3">
                <button @click="isEditing ? isEditing = false : window.location.href = '{{ route('formateur.qcms') }}'" 
        ...
        <div x-show="!loading" 
            ...
            <div x-show="!isEditing" class="space-y-6">
                ...
                <div class="flex flex-col items-center mb-8">
                    ...
                    <p class="text-[10px] font-black text-primary-600 mt-2.5 uppercase tracking-[0.2em]" x-text="profile.role || 'Formateur Référent'"></p>
                </div>
                ...
                <div class="bg-white border border-slate-100 rounded-[2.5rem] p-6 shadow-[0_8px_30px_rgba(0,0,0,0.02)]">
                    <div class="flex flex-col gap-5">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-[9px] font-black text-slate-300 uppercase tracking-[0.2em] mb-1">Matricule</p>
                                <p class="text-sm font-extrabold text-slate-900" x-text="profile.matricule || 'N/A'"></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <p class="text-center text-[9px] font-black text-slate-200 uppercase tracking-[0.4em] pt-6 leading-loose">
                SoliQuiz Formateur v1.0<br/> <span class="text-slate-100">© 2026 Solicode</span>
            </p>
