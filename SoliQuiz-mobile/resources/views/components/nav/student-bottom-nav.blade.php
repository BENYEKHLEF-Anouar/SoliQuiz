...
<nav class="fixed bottom-0 w-full max-w-[430px] bg-white border-t border-slate-200 z-50">
    <div class="flex justify-around items-center h-[72px] px-4 pb-safe">
        <a href="{{ route('student.dashboard') }}" class="flex flex-col items-center justify-center {{ request()->routeIs('student.dashboard') ? 'text-primary-500' : 'text-slate-400' }} gap-1.5">
        ...
        <a href="{{ route('student.history') }}" class="flex flex-col items-center justify-center {{ request()->routeIs('student.history') ? 'text-primary-500' : 'text-slate-400' }} gap-1.5">
            <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
            </svg>
            <span class="text-[10px] font-bold uppercase tracking-widest">Stats</span>
        </a>
        <a href="{{ route('student.profile') }}" class="flex flex-col items-center justify-center {{ request()->routeIs('student.profile') ? 'text-primary-500' : 'text-slate-400' }} gap-1.5">
            <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
