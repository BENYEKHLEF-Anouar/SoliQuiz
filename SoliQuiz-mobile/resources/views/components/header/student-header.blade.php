...
<header class="bg-white px-5 pt-safe-top pb-4 border-b border-slate-200 shadow-sm shrink-0 sticky top-0 z-40">
    ...
    <div class="flex justify-between items-center mt-2">
        ...
        <!-- Profile Dropdown - using slot for customization -->
        <div class="hs-dropdown relative inline-flex">
            <button id="hs-dropdown-profile" type="button" class="hs-dropdown-toggle w-10 h-10 rounded-full border border-slate-200 bg-white shadow-sm overflow-hidden active:scale-95 transition-transform">
            ...
            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-48 bg-white shadow-xl rounded-2xl p-2 mt-2 border border-slate-100 z-50" role="menu">
                <a class="flex items-center gap-x-3.5 py-2 px-3 rounded-xl text-sm text-slate-800 hover:bg-slate-50" href="{{ route('student.profile') }}">Mon Profil</a>
