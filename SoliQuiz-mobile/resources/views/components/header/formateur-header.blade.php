        ...
        <div class="flex items-center gap-3">
            <a class="flex items-center gap-2 group outline-none" href="#" aria-label="SoliQuiz Accueil">
                ...
                <div class="flex flex-col leading-none">
                    <span class="text-xl font-heading font-black text-white tracking-tight">Soli<span class="text-primary-400">Quiz</span></span>
                    <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-0.5">Formateur</span>
                </div>
            </a>
        </div>
